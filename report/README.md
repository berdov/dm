...
### Эксперимент 9.1: DIST-граф (анализ характеристик)
...
что при $n=\frac{500}{200}$ у нас есть аж три критерия с мощностью 1.
...
### Эксперимент 9.2: Сравнение моделей машинного обучения
